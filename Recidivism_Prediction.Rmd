...
Also, exploratory data analysis, we are able to discover some initial patterns and their relationships with recidivism outcomes. Next includes with statistical testing, feature engineering, and the development of logistic regression models with a threshold at 0.3 to capture the dynamics of recidivism. Moreover, we also include the ethical considerations of predictive modeling in criminal justice, mainly focusing on different demographic groups. By evaluating the model’s performance across these groups, we are capable to identify potential biases.

In terms of sensitivity and specificity, prioritizing sensitivity means the model is designed to detect as many positives as possible. In the context of recidivism prediction, this approach aims to identify most individuals who are likely to reoffend. However, the cost of high sensitivity is an increased risk of false positives—predicting recidivism when it will not occur. This can lead to unnecessary monitoring, which will come with social and economic costs. In contrast, prioritizing specificity focuses on accurately identifying those who will not reoffend. While this minimizes the risk of false positives, it increases the likelihood of false negatives—failing to predict actual cases of recidivism. Missing these cases could fail to prevent further criminal activities. Each approach has its trade-offs, and the choice often depends on the particular goals of the project and we will discuss further in our Cost-Benefit Analysis section.
