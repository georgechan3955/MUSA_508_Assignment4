...
anova_var <- c("recidivism_within_3years","supervision_risk_score_first", "percent_days_employed","avg_days_per_drugtest", "drugtests_thc_positive", "drugtests_meth_positive","drugtests_cocaine_positive")

new_names <- c( "supervision_risk_score_first"= "Supervision Risk Score",
                     "percent_days_employed" = "Percent Days Employed",
                     "jobs_per_year"= "Jobs Per Year",
                     "avg_days_per_drugtest" = "Avg Days Per Drugtest",
                     "drugtests_thc_positive" = "Drugtests_THC_Positive",
...
for (var in anova_var) {
  anova_result <- aov(numeric_var[[var]] ~ numeric_var$recidivism_within_3years)
