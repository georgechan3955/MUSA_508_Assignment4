...
recidivismModel <- glm(recidivism_within_3years_numreic ~ .,
                  data=recidivismTrain %>% 
                    dplyr::select(recidivism_within_3years_numreic,gender,race,age,dependents, supervision_level_first,education_level,prison_years,violations,supervision_risk_score_first, percent_days_employed,jobs_per_year,drugtests_thc_positive, drugtests_meth_positive,gang_affiliated), family="binomial" (link="logit"))
...
cvFit <- train(recidivism_within_3years_numreic~ .,
                  data=recidivism %>% 
                    dplyr::select(recidivism_within_3years_numreic,gender,race,age,dependents, supervision_level_first,education_level,prison_years,violations,supervision_risk_score_first, percent_days_employed,jobs_per_year,drugtests_thc_positive, drugtests_meth_positive,gang_affiliated), 
...
reg.noRace <- glm(recidivism_within_3years_numreic ~ ., data = 
                    recidivismTrain %>% dplyr::select(gender,age,dependents, supervision_level_first,education_level,prison_years,violations,supervision_risk_score_first, percent_days_employed,jobs_per_year,drugtests_thc_positive, drugtests_meth_positive,gang_affiliated, recidivism_within_3years_numreic),
                family = "binomial"(link = "logit"))

reg.withRace <- glm(recidivism_within_3years_numreic ~ ., data = 
                      recidivismTrain %>% dplyr::select(gender,race,age,dependents, supervision_level_first,education_level,prison_years,violations,supervision_risk_score_first, percent_days_employed,jobs_per_year,drugtests_thc_positive, drugtests_meth_positive,gang_affiliated, recidivism_within_3years_numreic),
                family = "binomial"(link = "logit"))
