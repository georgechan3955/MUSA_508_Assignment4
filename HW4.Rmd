...
And then comparing the observation and the predicted result from our model with the breakdown of race-gender groups, the plot below uncovers biases that might affect specific intersectional groups, such as Black Male and White Males, which are the groups that are over predicted as recidivism by our model.
